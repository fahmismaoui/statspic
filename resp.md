...
Le principe général de tous ces tests repose sur la comparaison de la valeur du test statistique (appelé statistique du test ou Tobs) avec une valeur critique. Si Tobs n'appartient pas à cet intervalle de confiance (Par exemple, on suppose que notre Tcrit = 1.96):
